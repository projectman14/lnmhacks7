      ...
      >
        <div className="flex flex-col mx-6 md:mx-12 lg:mx-24 mt-8 md:mt-12 lg:mt-16">
          ...
          <div className="flex flex-col relative mt-4 md:mt-8">
            ...
            {/* Main Content */}
            <div className="relative bg-[url('/Venue-bg.svg')] bg-cover lg:bg-contain bg-center bg-no-repeat w-full h-[120vh] overflow-hidden ">
              <div className="absolute inset-2 flex items-center justify-center my-2">
