...
const Schedule = () => {
    ...
    const [events, setEvents] = useState([{ name: "Registration Start", time: "9:00" }, { name: "OPENING CEREMONY", time: "9:45" }, { name: "Mentor Addresses", time: "12:00" }, { name: "LUNCH", time: "13:30" }, { name: "Q&A Session", time: "18:30" }, { name: "DINNER", time: "21:00" }])
    const Day1 = [{ name: "Registration Start", time: "9:00" }, { name: "OPENING CEREMONY", time: "9:45" }, { name: "Mentor Addresses", time: "12:00" }, { name: "LUNCH", time: "13:30" }, { name: "Q&A Session", time: "18:30" }, { name: "DINNER", time: "21:00" }]
    const Day2 = [{name : "Breakfast" , time : "8:00"} , {name : "Blockchain Workshop", time : "11:30"} , {name : "Lunch" , time : "2:00"} , {name : "Speaker Networking" , time : "18:00"} , {name : "Q&A Session" , time : "19:00"} , {name : "Dinner" , time : "20:30"} , {name : "Meme Quiz" , time : "21:40"}]
    ...
    return (
        <div className="bg-cover bg-center bg-no-repeat h-[120vh] w-screen bg-[#282729] overflow-hidden max-w-[1536px] 2xl:max-h-[890px]"
                        ...
                        <div className='flex'>
                            ...
                            <div className="flex flex-col my-10 ml-16 h-[26rem] overflow-y-scroll">
                                {events.map((event, index) => (
                                    <div key={index} className="flex justify-between -mt-[1.5rem] w-[34rem]">
