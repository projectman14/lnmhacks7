...
const About = ({ aboutRef }) => {
    ...
    return (
        <div className="bg-cover bg-center bg-no-repeat xl:h-[100vh] w-[100vw] bg-[#282729] overflow-hidden max-w-[1536px] 2xl:max-h-[864px] select-none"
            style={{ backgroundImage: `url(${background})` }}
            ref={aboutRef}>
            <div className='flex flex-col lg:flex-row lg:mx-[6rem] mt-8 mx-[2rem] select-none lg:pb-[2rem]'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-col lg:max-w-[56rem] xl:max-w-[48rem] lg:-ml-5' id='about-data'>
                        <h1 className='text-[#4DC081] font-Handjet lg:text-[3rem] font-extrabold mt-[1.5rem] tracking-widest text-[2.5rem] lg:pb-[0.25rem]'>About LNM hacks</h1>
                        <h2 className='text-[#FFFFFF] font-IBM-PLEX-MONO lg:text-[1.6rem] xl:text-[1.9rem] mt-[1.5rem] tracking-wide text-[1.35rem]'>
                ...
                <div
                    className="hidden lg:flex items-center h-full mt-[5rem] md:mt-[6rem] lg:mt-[7rem] md:ml-20 lg:ml-36 "
