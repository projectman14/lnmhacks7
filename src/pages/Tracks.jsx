...
import Bounties from "../../public/Bounties.svg";
        ...
        >
            ...
            <div className='relative z-10 pt-16 pb-24'>
                <div className="flex items-center justify-center lg:ml-0 ml-5 max-md:ml-0  mb-8">
                    <TopicButton className={'text-lg md:text-xl font-normal tracking-wider'} text={'Topic#3-Tracks and Bounties'} />
                </div>
                <div className='text-center mb-16 flex justify-center'>
                    <img src={Bounties} alt="Sponsor" />
                </div>
                ...
                <div className='max-w-7xl mx-auto overflow-y-scroll z-50'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-6 mt-[3rem]'>
                        <TracksCard className={"h-[18rem]"} src={RiseIn} bounty={"850"}/>
                        <TracksCard className={"h-[18rem]"} src={Jackpot} bounty={"850"}/>
                        <TracksCard className={"h-[18rem] p-4"} src={Devdock} bounty={"850"}/>
                    </div>
