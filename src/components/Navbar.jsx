...
const Navbar = ({ aboutRef, ctfRef, venueRef, faqRef , scheduleRef}) => {
  ...
  return (
    <div className='flex flex-col lg:flex-row justify-between mx-4 lg:mx-16 relative z-10'>
      <div className={`flex mt-2 2xl:mt-8 ${window.screen.width > 1300 ? '' : 'mx-auto'}`} id='logo'>
      ...
      <div className={`flex flex-wrap justify-center lg:justify-end items-center animation-opacity-navbar ${window.screen.width > 1300 ? '' : 'hidden'}`}>
